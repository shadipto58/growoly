          ...
          <div className="flex flex-col justify-center">
            <div className="max-w-xl mb-6">
              ...
              <p className="text-base text-gray-700 dark:text-gray-200 md:text-lg whitespace-normal">
                ...
                <br />
                <br /> Our goal is clear: to empower developers and businesses
                while promoting simplicity, innovation and creativity. Lets
                collaborate and drive growth together, shaping the future of
                your business
              </p>
            </div>
          </div>
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700 dark:text-gray-200">
                  ...
                  aspect is done precisely and carefully, bringing your vision
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700 dark:text-gray-200">
                  ...
                  strategy as your business expands. By acknowledging feedback
                  and insights, we continuously refine our approach to ensure
                  sustained success in the dynamic digital arena.
                </p>
              </div>
            </div>
            <div className="flex">
