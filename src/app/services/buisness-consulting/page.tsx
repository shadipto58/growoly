      ...
      <div className="my-10 lg:my-20 flex flex-col lg:flex-row items-center justify-between gap-20">
        <div className="lg:w-1/2">
          ...
          <p className="text-base text-primary md:text-lg whitespace-normal lg:max-w-xl">
            ...
            businesses navigate challenges, capitalize on opportunities, and
            achieve their goals. From operational optimization to market
            expansion strategies, our consultancy empowers organizations to
            thrive in todays dynamic business landscape. With a focus on
            innovation, collaboration, and results, we are dedicated to
            delivering measurable value and sustainable solutions that propel
            businesses forward
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-5">
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                numerous aspects, including operations, finances, marketing, and
                human resources.
              </p>
            </div>
            ...
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                objectives, action plans, and milestones to help guide the
            ...
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                training to ensure smooth execution and adoption of recommended
                solutions.
              </p>
            </div>
            <div className="flex items-center justify-center">
            ...
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                to the client and make necessary adjustments to optimize
                outcomes and ensure ongoing success.
              </p>
            </div>
          </div>
        </div>
