                    ...
                    <div className="flex flex-col lg:flex-row gap-5">
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-200">
                                At first, We try to Understand business
                                objectives, target audience, and competition to
                                develop a comprehensive digital marketing
                                strategy. This involves identifying key
                                channels, setting measurable goals, and
                                outlining tactics to achieve them.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-200">
                                After that, Our expert marketing team execute
                                the digital marketing strategy across chosen
                                channels, which may include search engines,
                                social media platforms, email, content
                                marketing, and more. This involves creating and
                                optimizing content, launching campaigns, and
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-200">
                                Third,Our marketing team Monitor campaign
                                performance using analytics tools to track key
                                metrics like traffic, engagement, conversion
                                rates, and ROI. Analyze data to identify
                                strengths, weaknesses, opportunities, and
                                threats, making data-driven decisions to
                        ...
                        >
                            ...
                            <p className="text-gray-600 dark:text-gray-200">
                                At last we Continuously refine campaigns based
                                on data insights to improve performance and
                                achieve objectives more effectively. Adjust ad
                                creatives, targeting, and overall strategy to
                                adapt to changing market dynamics and consumer
                                behavior.
                            </p>
                        </div>
                    </div>
