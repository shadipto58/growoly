      ...
      <div className="my-10 lg:my-20 flex flex-col lg:flex-row items-center justify-between gap-20">
        <div className="lg:w-1/2">
          ...
          <p className="text-base text-primary md:text-lg whitespace-normal lg:max-w-xl">
            Growolys creative arena, where graphic design crosses borders to
            visually capture and transmit your brands soul. Our talented graphic
            designers specialised in creating eye-catching visual identities
            that connect with your target audience. From logos that tell your
            brands story to eye-catching marketing collateral, we flawlessly
            combine artistry and smart thinking. At Growoly, we understand the
            significance of images in delivering messages, thus we make certain
            that each design element flows effortlessly with your brand
            narrative. Elevate your brands aesthetics with our inventive graphic
            design solutions, designed to leave a lasting impression and develop
            a strong visual identity in the competitive digital market. Choose
            Growoly for a visual experience that turns ideas into breathtaking
            reality.
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-5">
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                At first, We try to Understand business objectives, target
                audience, and competition to develop a comprehensive digital
                marketing strategy. This involves identifying key channels,
                setting measurable goals, and outlining tactics to achieve them.
              </p>
            </div>
            ...
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                After that, Our expert marketing team execute the digital
                marketing strategy across chosen channels, which may include
                search engines, social media platforms, email, content
                marketing, and more. This involves creating and optimizing
                content, launching campaigns, and managing advertising budgets
                effectively.
              </p>
            </div>
            <div className="flex items-center justify-center">
            ...
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                Third,Our marketing team Monitor campaign performance using
                analytics tools to track key metrics like traffic, engagement,
                conversion rates, and ROI. Analyze data to identify strengths,
                weaknesses, opportunities, and threats, making data-driven
                decisions to optimize campaigns for better results.
              </p>
            </div>
            <div className="flex items-center justify-center">
              <FaArrowRightLong className="text-3xl lg:rotate-0 rotate-90" />
            ...
            <div className="p-5 lg:w-fit md:w-1/2 w-full mx-auto border-2 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg">
              ...
              <p className="text-gray-600">
                At last we Continuously refine campaigns based on data insights
                to improve performance and achieve objectives more effectively.
                Adjust ad creatives, targeting, and overall strategy to adapt to
