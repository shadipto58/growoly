  ...
  return (
    <main className="">
        <section className={`bg-white dark:bg-[#183D3D] ${theme == "light"? "":"dotstyle"}`}>
          <div className="py-10 container mx-auto lg:py-24 flex flex-col lg:flex-row items-start justify-between gap-20">
        ...
        <section className="bg-white dark:bg-[#040D12] dark:text-[#4d9d30] md:py-20 py-10">
          <div className="py-16 mx-auto lg:py-20 container">
            ...
            <div className="flex flex-col lg:flex-row gap-5">
              <div className={`p-5 dark:bg-[#1B4242] ${theme == "light"? "":"boxglow"} lg:w-[300px] md:w-1/2 w-full mx-auto border-2 dark:border hover:scale-110 transition-all duration-200 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg`}>
                <div className="flex items-center justify-between mb-6">
                  <p className="text-2xl font-bold dark:text-primary">Step 1</p>
                </div>
              ...
              <div className={`p-5 dark:bg-[#1B4242] ${theme == "light"? "":"boxglow"} lg:w-[300px] md:w-1/2 w-full mx-auto border-2 dark:border hover:scale-110 transition-all duration-200 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg`}>
                <div className="flex items-center justify-between mb-6">
                  <p className="text-2xl font-bold dark:text-primary">Step 2</p>
                </div>
                <p className="text-gray-600 dark:text-gray-200">
              ...
              <div className={`p-5 dark:bg-[#1B4242] ${theme == "light"? "":"boxglow"} lg:w-[300px] md:w-1/2 w-full mx-auto border-2 dark:border hover:scale-110 transition-all duration-200 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg`}>
                <div className="flex items-center justify-between mb-6">
                  <p className="text-2xl font-bold dark:text-primary">Step 3</p>
                </div>
                <p className="text-gray-600 dark:text-gray-200">
              ...
              <div className={`p-5 dark:bg-[#1B4242] ${theme == "light"? "":"boxglow"} lg:w-[300px] md:w-1/2 w-full mx-auto border-2 dark:border hover:scale-110 transition-all duration-200 border-[#BFD8AF] rounded-lg bg-[#EEEEEE] shadow-lg`}>
                <div className="flex items-center justify-between mb-6">
                  <p className="text-2xl font-bold dark:text-primary">Step 4</p>
                </div>
                <p className="text-gray-600 dark:text-gray-200">
        ...
        {/* Meet Our Team */}
        {/* <section className={`md:py-28 py-20 bg-white dark:bg-[#183D3D] ${theme == "light"? "":"dotstyle"}`}>
          <div className="">
